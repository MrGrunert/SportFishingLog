    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FishinGrounds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FishinGrounds_Parishes_ParishId",
                        column: x => x.ParishId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(nullable: false),
                    FishingGroundId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Catches_FishinGrounds_FishingGroundId",
                        column: x => x.FishingGroundId,
                        principalTable: "FishinGrounds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Catches_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Catches_FishingGroundId",
                table: "Catches",
                column: "FishingGroundId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FishinGrounds_ParishId",
                table: "FishinGrounds",
                column: "ParishId");
        }
